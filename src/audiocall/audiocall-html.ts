...
export const renderLevel = async (group: number) => {
  ...
  const html = `
    ...
    <div "onclick="document.getElementById('${array[answer_number].audio}-audio').play()" data-word="${array[answer_number].wordTranslate}" class="audio-audiocall-game">
    ...
    <div class="answers__container">
      <button data-number="Digit1" data-word="${array[answer_number].wordTranslate}" value="${array[answer_number].wordTranslate}" id="${array[answer_number].id}" class="answers answer1">${array[answer_number].wordTranslate}</button>
    ...
    <div class="container">
      <div class="audiocall__body">
        <div class="audiocall-description">
          ...
          <div class="audiocall-text">Подсказка!</div>
